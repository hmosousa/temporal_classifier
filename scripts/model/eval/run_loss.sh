...
python scripts/model/eval/point.py -m models/smol-135-tq -d matres -b 1024
python scripts/model/eval/point.py -m models/smol-135-tq-augment -d matres -b 1024
python scripts/model/eval/point.py -m models/smol-135-tq-closure -d matres -b 1024
python scripts/model/eval/point.py -m models/smol-135-tq-synthetic -d matres -b 1024
...
python scripts/model/eval/interval.py -m models/smol-135-tq-augment -d tddiscourse
python scripts/model/eval/interval.py -m models/smol-135-tq-closure -d tddiscourse
python scripts/model/eval/interval.py -m models/smol-135-tq-synthetic -d tddiscourse
