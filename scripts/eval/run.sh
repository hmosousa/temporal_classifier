...
python scripts/eval/point.py -m hugosousa/smol-135-tq -d temporal_questions -c raw
python scripts/eval/point.py -m hugosousa/smol-135-tq-augment -d temporal_questions -c raw
python scripts/eval/point.py -m hugosousa/smol-135-tq-closure -d temporal_questions -c raw
python scripts/eval/point.py -m hugosousa/smol-135-tq-synthetic -d temporal_questions -c raw
python scripts/eval/point.py -m hugosousa/smol-135-tq-closure-augment -d temporal_questions -c raw
python scripts/eval/point.py -m hugosousa/smol-135-tq-closure-synthetic -d temporal_questions -c raw
python scripts/eval/point.py -m hugosousa/smol-135-tq-augment-synthetic -d temporal_questions -c raw
python scripts/eval/point.py -m hugosousa/smol-135-tq-closure-augment-synthetic -d temporal_questions -c raw

## Closure temporal questions
python scripts/eval/point.py -m random -d temporal_questions -c closure
python scripts/eval/point.py -m majority -d temporal_questions -c closure
python scripts/eval/point.py -m hugosousa/smol-135-tq -d temporal_questions -c closure
python scripts/eval/point.py -m hugosousa/smol-135-tq-augment -d temporal_questions -c closure
python scripts/eval/point.py -m hugosousa/smol-135-tq-closure -d temporal_questions -c closure
python scripts/eval/point.py -m hugosousa/smol-135-tq-synthetic -d temporal_questions -c closure
python scripts/eval/point.py -m hugosousa/smol-135-tq-closure-augment -d temporal_questions -c closure
python scripts/eval/point.py -m hugosousa/smol-135-tq-closure-synthetic -d temporal_questions -c closure
python scripts/eval/point.py -m hugosousa/smol-135-tq-augment-synthetic -d temporal_questions -c closure
python scripts/eval/point.py -m hugosousa/smol-135-tq-closure-augment-synthetic -d temporal_questions -c closure
...
python scripts/eval/interval.py -m hugosousa/smol-135-tq-closure -d tempeval_3
